"""Genera dashboard_v3/index.html (versión con exportación CSV, top-N, heatmap y búsqueda global).

Reutiliza los datasets de build_dashboard.py y agrega el payload "quality" desde
data_quality.compute(). Lee scripts/dashboard_template_v3.html.
"""
import json
import os
import sys
...
TEMPLATE = os.path.join(ROOT, "scripts", "dashboard_template_v3.html")
OUT = os.path.join(ROOT, "dashboard_v3", "index.html")
